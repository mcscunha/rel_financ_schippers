...
select 
    pcmov.codfilial, pcmov.dtmov, pcmov.numnota, pcmov.codepto,
    pcmov.descricao, pcmov.numtranshistorico, pcmov.qt, 
    pcmov.punit, pcmov.custofin, pcmov.custocont, pcmov.custoreal,
